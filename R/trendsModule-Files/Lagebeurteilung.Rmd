...
b117weekStart <- parse_date_time(str_c(mostRecentb117$year_week,"-1"), "Y-W-w")
...
s501yv2weekStart <- parse_date_time(str_c(mostRecents501yv2$year_week,"-1"), "Y-W-w")
...
In Kalenderwoche `r mostRecentb117$week`, `r mostRecentb117$year` (ab dem `r format(b117weekStart, "%d.%m.%Y")`)
wurde die Häufigkeit von B.1.1.7 in der Schweiz auf etwa `r format(round(mostRecentb117$p, 2), decimal.mark = ',')`% geschätzt
(95%-Unsicherheitsinterval `r format(round(mostRecentb117$p_lower, 2), decimal.mark = ',')`%-`r format(round(mostRecentb117$p_upper, 2), decimal.mark = ',')`%;

...
Seit Juli 2021 gibt es klare Anzeichen für einen kontinuierlichen Anstieg.
<!------ UPDATE  -------->
...
Wir beobachten statistisch signifikant steigende Fallzahlen in allen Altersgruppen.
Der Anstieg in den 65-74 Jährigen ist mit 153% (290%-66%) pro Woche momentan am stärksten.
...
In der Kalenderwoche 28 war die Häufigkeit von Delta 96%.
...
hatten über die letzten 14 Tage gemittelt eine Häufigkeit von respektive 0.1% und 0.5% [^29].
...
Delta hatte
in der Kalenderwoche 26 eine Häufigkeit von 67%,
in der Kalenderwoche 27 eine Häufigkeit von 85% und
in der Kalenderwoche 28 eine Häufigkeit von 96%
unter den sequenzierten Fällen [^29].
Wegen Verzögerungen, mit denen die Sequenzen erfasst werden, können sich diese Häufigkeit, vor allem in Kalenderwoche 28, noch ändern.
Aus diesem Anstieg der Häufigkeit von Delta kann man einen Transmissionsvorteil gegenüber Alpha von 67-75% berechnen[^29].
<!--- UPDATE cov-spectrum.ethz.ch-> click on B.1.617.2 and look at the number/percentage by calendar week on the right graph  ---->

Delta dominiert mittlerweile die Epidemie in vielen Ländern, darunter Grossbritannien[^36], den Vereinigten Staaten von Amerika, Frankreich, Deutschland, Italien und Portugal[^29].
...
Einem Preprint aus Kanada[^41] und einer Studie aus Schottland[^42] zufolge ist die Hospitalisierungsrate von Delta im Vergleich zu Alpha um 74%-85% erhöht.
...
Zeitverzögert steigen dort nun auch die Zahl der Spitaleintritte wieder an[^38].
...
Wir rechnen auch mit einem weiteren Anstieg von Hospitalisierungen, der wegen der geringeren Impfdeckung in der Schweiz verglichen mit Grossbritannien[^39] voraussichtlich einen grösseren Anteil der Infizierten betreffen wird.
...
[^40]: https://depositonce.tu-berlin.de/handle/11303/13423
[^41]: https://doi.org/10.1101/2021.07.05.21260050
[^42]: https://www.thelancet.com/journals/lancet/article/PIIS0140-6736(21)01358-1/fulltext

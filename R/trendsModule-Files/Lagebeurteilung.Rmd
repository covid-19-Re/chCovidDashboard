...
Eine 50-59 jährige positiv getestete Person hat beispielsweise ein Risiko von 4,2% eines Spitaleintritts in 2021, wenn sie mit der Variante B.1.1.7 infiziert ist. Für eine Person, die mit einer anderen Variante infiziert ist, liegt dieses Risiko bei nur 2,1%[^29].
...
Die im ersten Quartal des Jahres 2021 erstmals in der Schweiz nachgewiesenen Varianten B.1.351, P.1 und B.1.617 treten momentan mit jeweils weniger als 1% auf[^29].
<!--- UPDATE cov-spectrum.ethz.ch-> Click on B.1.315 or P.1 ---->
Die ursprünglich in Indien beschriebene B.1.617 Variante wurde bisher in 106 Fällen in der Schweiz nachgewiesen.
...
Die Epidemie, die in Grossbritannien von B.1.617.2 dominiert ist, steigt signifikant an (7-Tageschnitt der Reproduktionszahl ist 1,37 (1,23 - 1,51), gemessen vom 24.-30. Mai 2021[^1]).
<!--- UPDATE  ---->

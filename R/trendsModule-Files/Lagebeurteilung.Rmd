...
Nach einem raschen Anstieg der Fallzahlen in den darauffolgenden zwei Wochen, sind sie nun auf sehr hohem Niveau.
Der Anstieg ist deutlich abgeflacht: der R-Wert ist nur noch marginal, aber statistisch signifikant, über 1 und die Anzahl der erfassten Fälle stiegen während der letzten zwei Wochen nicht signifikant.
Der flachere Antieg der erfassten Fälle könnte auf das Ende der Omikron-welle hindeuten.
Allerdings könnte er auch durch die Grenzen der Erfassung durch Tests zustande kommen
(denn die Fallzahlen und der Anteil der positiven Tests sind höher als je zuvor in der Pandemie).
...
Die Hospitalisierungen fielen mit einer Rate von `r valueUIchange(rankingCHEhospitalizations)` pro Woche
und
...
Die Zahl der Fälle nahm in den Altersgruppen der 0-9 und 10-19 Jährigen signifikant zu, und in den 20-29 Jährigen signifikant ab.
Der Anstieg in den 0-9 Jährigen war mit 70% (95% UI: 55-86%) pro Woche am schnellsten.
In dieser Altergruppe nahmen auch die Hospitalisierungen signifikant zu.
In den Altersgruppen der 60-69, 70-79 und über 80 Jährigen fielen die Hospitalisierungen signifikant.
...
Mittlerweile wurde Omikron in 89 Ländern in Europa und weltweit nachgewiesen (Stand 16. Dezember 2021) [^302],[^303],[^324], anfänglich meist verknüpft mit Einreise von Ländern aus dem Süden Afrikas.
In der Schweiz wurde die Variante über 3000-mal nachgewiesen und hatte in der ersten Kalenderwoche 2022 einen Anteil von 83% unter allen sequenzierten Proben[^25].
...
Die UKHSA[^337] schätzt, dass das Hospitalisierungsrisiko einer Person, die symptomatisch mit Omikron infiziert ist, um 68% (95% UI: 42-82%) reduziert ist.


#### Schwere der Infektion

Laut einer Studie des CDC[^338] ist die Inkubationszeit einer Infektion mit Omikron mit ungefähr 3 Tagen kürzer als die der früher zirkulierenden Varianten.
...
Wenn man nicht fuer den Impfstatus korrigiert, kommt man zum Schluss, dass Infektionen mit Omikron seltener zu einer Hospitalisation führen.
...
Einer Studie des UKHSA zufolge [^337] ist die Hazard Ratio eines Spitaleintritts nach einer Omikron-Infektion 0.33 (95% UI: 0.30 to 0.37), was einer 67% niedrigeren Hospitalizationsrate entspricht.
<!--- UPDATE! [^337]

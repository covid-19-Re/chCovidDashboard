...
Die Zahl der bestätigten Fälle stieg bis Ende Januar 2022 kontinuierlich an und nahm dann bis Kalenderwoche 8 2022 ab.
Seit drei Wochen steigen die Fallzahlen wieder.
Dieser Trend wird auch in Abwasserproben beobachtet [^23],[^62].
Die aktuellste Schätzung des R-Wertes, welche das Infektionsgeschehen bis zum 4.3.2022 wiedergibt, ist signifikant über 1.

Der Anstieg der Fallzahlen betrifft am stärksten die Altersgruppen der über 60-Jährigen.
Im Einklang mit dieser Entwicklung der Fallzahlen steigen die Hospitalisierungen signifikant.

In der Schweiz ist seit Kalenderwoche 51 2021 die Omikron Variante dominant. Seit Kalenderwoche 3 2022 hat diese Variante eine Häufigkeit von über 95% aller Infektionen in der Schweiz. Es zirkulieren die Omikron Varianten BA.1 und BA.2. BA.1 hatte in Kalenderwoche 3 eine Häufigkeit von über 95%. Seitdem geht die Häufigkeit von BA.1 zurück und war in Kalenderwoche 9 2022 bei 43%. Die Omikron-Untervariante BA.2 hat die letzten Wochen zugenommen und machte in Kalenderwoche 9 2022 57% der sequenzierten Proben aus.

Der erneute Anstieg der gemeldeten Fälle scheint sowohl auf die Ausbreitung von BA.2 sowie den Öffnungsschritten von Kalenderwoche 7 2022 zurückzuführen sein.
...
<!------- UPDATE -------->
Gemäss den aktuellsten Schätzungen war der R-Wert seit seinem Höchststand von 1,5 am 25.12.2021 bis auf wenige Tage in der ersten Kalenderwoche 2022 signifikant über 1, ist dann gefallen und 
war von 21. Januar bis 13. Februar 2022 signifikant unter 1.
Seit dem 19. Februar 2022 ist er wieder signifikant über 1.
...
Die gemeldeten Hospitalisierungen stiegen mit einer Rate von `r valueUIchange(rankingCHEhospitalizations)` pro Woche,
wobei diese Zahl wegen den erwähnten Meldeverzögerungen[^345] noch verfälscht sein könnte.
Die Todesfälle nahmen mit einer Rate von `r valueUIchange(rankingCHEdeaths)` pro Woche ab.
<!---- UPDATE ---->
...
Die Zahl der Fälle stieg in allen Altersgruppen über die letzten 14 Tage signifikant ausser bei den 0-9 Jährigen.
Der stärkste Antieg betrifft die über 80-Jährigen mit einer Rate von 67% (95% UI: 44-94%) pro Woche, gefolgt von den 70-79-Jährigen (66%; 95% UI: 42-94% pro Woche) und 60-69-Jährigen (56%; 95% UI: 37-77% pro Woche).
...
Seit Kalenderwoche 9 2022 is der Omikron-Subtyp BA.2 in der Schweiz dominant.
In der Kalenderwoche 51 2021 wurde der Omikron-Subtyp BA.1 in der Schweiz dominant und wurde seitdem über 20'000-mal nachgewiesen. Nachdem BA.1 in Kalenderwoche 3 2022 eine Häufigkeit von über 95% hatte, ist die Häufigkeit gesunken auf 43% in Kalenderwoche 9 2022[^25]. Der Omikron-Subtyp BA.2 wurde erstmals in KW 52 2021 in der Schweiz nachgewiesen. Seitdem wurde dieser Subtyp über 2500-mal nachgewiesen und hatte in Kalenderwoche 9 2022 einen Anteil von 57% unter allen sequenzierten Proben[^25]. 
<!--- UPDATE ---->

Die bisherigen Studien zur epidemiologischen Ausbreitung von Omikron BA.1, den Impfschutz gegen diese Variante und der Schwere von Omikron-Infektionen sind in unseren Berichten den Task Force Berichten der letzten Wochen diskutiert[^346].
BA.2 scheint einen Übertragungsvorteil gegenüber BA.1 zu besitzten: in einem Preprint beschriebenen dänischen Studie wurden Sekundärangriffsraten von BA.1 und BA.2 zu 29% and 39% geschätzt [^347];
<!--- The secondary attack rate (SAR) was estimated as 29% and 39% in 17
households infected with Omicron BA.1 and BA.2, respectively.  ---->
<!--- UPDATE ---->
und in einer neueren Studie aus England (Preprint [^356]) wird geschätzt, dass BA.2 die effektive Reproduktionszahl (*R~e~*) um 0.40 (95% UI: 0.36–0.43) erhöht.
Obwohl BA.2 in Hamstern schwerere Verläufe verursacht als BA.1[^352], zeigen klinisch-epidemiologische Daten aus Südafrika[^353], Grossbritannien und Dänemark keine Anzeichen für einen relevanten Unterschied im Schweregrad der Erkrankungen[^351]. 

Vorläufige Reinfektions-Daten in der Bevölkerung legen Nahe, dass eine Infektion mit der Untervariante BA.1 starke Kreuzimmunität gegen eine Infektion mit BA.2 erzeugt[^351].
Gemäss der UK Health Security Agency (UKHSA) ist der Schutz der Impfung (nicht nach Impfstoff aufgeschlüsselt) vor symptomatischer Infektion mit BA.2 gleich wie für BA.1[^354].
Eine neue Studie aus Katar[^357], die nur mRNA Impfstoffe untersucht, fand keinen Unterschied in der Wirksamkeit gegen symptomatische Infektion mit BA.1 und BA.2. 
<!--- initial data from population-level reinfection studies suggest that infection with BA.1 provides strong protection against reinfection with BA.2 ---->
Hingegen ist bei BA.2 die Aktivität des monoklonalen Antikörpers Sotrovimab, der in der Schweiz therapeutisch eingesetzt wird, deutlich vermindert[^348],[^349] und somit sind momentan die antiviralen Behandlungsoptionen in der Schweiz stark eingeschränkt. 
<!--- UPDATE ---->

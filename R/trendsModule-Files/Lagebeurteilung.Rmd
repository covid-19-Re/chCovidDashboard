...
BA.2 scheint einen Übertragungsvorteil gegenüber BA.1 zu besitzten: in einer in einem Preprint beschriebenen dänischen Studie wurden Sekundärangriffsraten von BA.1 und BA.2 zu 29% and 39% geschätzt [^347].  
...
Obwohl BA.2 in Hamstern schwerere Verläufe zeigt als BA.1[^352], gibt in epidemiologischen Daten aus Südafrika, Grossbritannien und Dänemark keine Anzeichen für einen Unterschied in der Schwere[^351].

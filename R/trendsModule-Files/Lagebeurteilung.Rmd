...
[^1]: https://sciencetaskforce.ch/aktuelle-lage und https://ibz-shiny.ethz.ch/covid-19-re/: Die einzelnen Schätzerte von *R~e~* unterliegen starken Schwankungen und müssen mit Vorsicht interpretiert werden. Aufgrund der verwendeten Methodik kann die tatsächliche Unsicherheit um die Schätzwerte nicht vollständig dargestellt werden.

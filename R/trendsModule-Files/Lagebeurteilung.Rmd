...
Seit Juli 2021 gibt es klare Anzeichen für einen Anstieg.
<!------ UPDATE  -------->
...
Die ursprünglich in Indien beschriebene Variante Delta, die Public Health England als "variant of concern (VOC)" klassifiziert hat, wurde bisher in mehreren Hundert Fällen in der Schweiz nachgewiesen.
Delta hatte
...
Aus diesem Anstieg der Häufigkeit von Delta kann man einen Transmissionsvorteil con ungefähr 50% berechnen.
Extrapoliert auf die gesamte Epidemie ergeben sich täglich Dutzende Infektionen mit der Delta-Variante.
Da die absolute Zahl der täglichen Infektionen klar ansteigt und Delta dominiert, ist die Wahrscheinlichkeit einer epidemischen Welle in den nächsten Wochen hoch.
<!--- UPDATE cov-spectrum.ethz.ch-> click on B.1.617.2 and look at the number/percentage by calendar week on the right graph  ---->

Delta dominiert auch die Epidemie in Grossbritannien[^36], den Vereinigten Staaten von Amerika, Deutschland, Italien und Portugal[^29].

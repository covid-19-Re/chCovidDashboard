...
Seit Ende November 2021 steigt auch die Belegung der Intensivstationen mit COVID-19 Patienten signifikant an, momentan mit einer Rate von 16% (95% UI: 6-28%) pro Woche.
Die zweite kritische Schwelle von 300 Intensivbettenbelegungen ist schon fast überschritten,
über der alle Spitäler weniger dringliche Eingriffe verschieben müssen und in manchen Spitälern implizit triagiert werden muss und ad-hoc Betten bereitgestellt werden[^61].
Seit vorletzter Woche steigen auch die Todesfälle signifikant an, mit einer momentanen Rate von 40% pro Woche (95% UI: 14-71%). 
<!------ UPDATE  -------->
...
<!------- UPDATE -------->
Seit Ende Oktober 2021 ist die Schätzung des R-Wertes wieder signifikant über 1.
Diese Woche ist der R-Wert aber etwas niedriger als noch vor zwei Wochen, jedoch immer noch signifikant über 1.
...
Die Zahl der Fälle ist nur in der Altersgruppe der 0-9 Jährigen signifikant steigend.
In den 70-79 Jährigen und über 80 Jährigen sinkt sie sogar signifikant.
Im Gegensatz zu vorletzter Woche stiegen die Hospitalisierungen
nur in der Altersgruppe der 40-49 Jährigen signifikant an.
...
von Kalenderwoche 38 bis Kalenderwoche 49 eine Häufigkeit von 100% unter den sequenzierten Fällen.
In der aktuellen Kalenderwoche 51 sehen wir jetzt vermehrt auch Sequenzen der Omikron-Variante[^25].
...
In der Schweiz wurde die Variante mehrmals nachgewiesen[^303].
<!--- UPDATE https://cov-spectrum.org/explore/Switzerland/AllSamples/AllTimes/variants?pangoLineage=B.1.1.529 ---->

In Grossbritannien [^312] und in Dänemark[^313] steigt der Anteil an Omikron sehr schnell an, was einen Wachstumsvorteil in mehrheitlich geimpften Populationen suggeriert.
Daten aus Südafrika erlauben eine vorläufige Schätzung des logistischen Wachstumsrate von Omikron gegenüber Delta von 0,32 (95% UI: 0,09-0,55) pro Tag[^314]. (Als Referenz: die logistische Wachstumsrate von Alpha gegenüber der ursprünglichen Variante wurde mit derselben Methode 5-mal niedriger, zu 0.065 pro Tag, geschätzt.)
<!--- Ganz grob entspräche diese logistische das einem Sprung von Re von 1.1 auf 3. ---->

Omikron ist genetisch am engsten verwandt mit den Varianten, die im ersten Halbjahr 2020 zirkulierten, und ist nicht direkt aus einer anderen besorgniserregenden Variante entstanden[^304]. Omikron unterscheidet sich durch rund 30 Mutationen im Stachelprotein von den ursprünglich zirkulierenden Varianten[^303]. Diese Mutationen haben wichtige Teile des Stachelproteins deutlich verändert.

Forschungsergebnisse der letzten Woche[^307],[^308],[^309],[^310] zeigen eine starke Verringerung der Neutralisation von Omikron mit Seren von Geimpften und Genesenen.
Allgemein ergibt sich das Bild, dass Seren Geimpfter Genesener mehr neutralisieren als die Seren doppelt Geimpfter.
Eine dritte Impfdosis führt zu einer starken Erhöhung der Neutralisation.
Ein Preprint[^311] hat auf Grund epidemiologischer Daten die Wirksamkeit der Impfstoffe von Oxford/AstraSeneca und BioNTech/Pfizer gegen die symptomatische Infektion mit Omikron geschätzt: der Schutz von BioNTech/Pfizer fiel von 88% 2-9 Woche nach der zweiten Impfung auf rund 35% nach 15 Wochen.
Auch in dieser Studie führt eine dritte Impfdosis zu einer starken Erhöhung des reduzierten Schutzes.
<!--- UPDATE ---->

Die aktuelle Datenlage legt also nahe, dass eine dritte Impfdosis die zu erwartete Krankheitslast durch Infektionen mit Omikron reduzieren kann. Eine massive Erhöhung der Impfgeschwindigkeit würde erlauben, dass ein grösserer Teil der Geimpften ihre dritte Dosis erhalten könnten vor einer Ansteckung mit Omikron.

Wir erwarten in den kommenden Wochen weitere Informationen über die Eigenschaften von Omikron und detailliertere Daten über den Schutz durch Impfung und Genesung vor einer Ansteckung und vor einem schweren Krankheitsverlauf. Für Delta, die aktuell dominierende Variante, ist solche Information schon vorhanden; wir fassen den momentanen Kenntnisstand im Folgenden kurz zusammen. 


### Impfschutz gegen Delta durch zwei Impfdosen über die Zeit
...
Seit Oktober sehen wir in der Schweiz nun jedoch eine Abnahme der Wirksamkeit in den über 80-Jährigen von 89-94% im September auf 73-87%[^57].
Diese Abnahme der Impfwirksamkeit ist konsistent mit Daten aus anderen Ländern. 
Ein neuer Preprint[^122] beschreibt eine umfassendere Studie der Universität Bern, die eine niedrigere Wirksamkeit der Impfung gegen Hospitalisierung in Menschen über 70 Jahren schätzt als in der allgemeinen Bevölkerung und auch eine Abnahme der Impfwirksamkeit gegen Hospitalisation nach 25 Wochen feststellt, aber nicht in Menschen über 70 Jahren. 

Dies bedeutet, dass junge doppelt geimpfte Menschen nach wie vor rund 20-mal besser vor einer Hospitalisierung geschützt sind als nicht geimpfte Menschen (entspricht Schutz 95%). Bei älteren doppelt geimpften Menschen ist der Schutz niedriger, aber immer noch rund 5-mal besser als in Ungeimpften (entspricht Schutz 80%).
...
### Wirkung der dritten Impfdosis gegen Delta

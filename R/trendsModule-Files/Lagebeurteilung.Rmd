...
Die ursprünglich in Indien beschriebene Variante Delta (B.1.617.2), die Public Health England als "variant of concern (VOC)" klassifiziert hat, wurde bisher in 214 Fällen in der Schweiz nachgewiesen.
Delta hatte
...
Die Epidemie in Grossbritannien, die von Delta dominiert ist, steigt signifikant an (7-Tageschnitt der Reproduktionszahl ist

...
Die beobachtete rasche Zunahme der Fälle bis Anfang Dezember und damit der weiter anhaltende Anstieg in Intensivbettenbelegungen, ist für das stark belastete Gesundheitswesen sehr schwierig zu bewältigen. 
<!------ UPDATE  -------->

Von der Weltgesundheitsorganisation (WHO) wurde die neue Variante Omikron am 26.11.2021 als besorgniserregend deklariert.
Auch in der Schweiz wurde diese Variante schon über 100-mal nachgewiesen und der Anteil an den bestätigten Fällen wird in Kalenderwoche 49 auf 3-8% geschätzt.
...
Die Zahl der Fälle ist in allen Altersgruppen signifikant abnehmend ausser 
...
Die Impfung wirkt sehr gut gegen schwere Verläufe bei Delta (80% in Älteren, 95% in Jüngeren; je 6 Monate nah der zweiten Impfdosis) und bietet gewissen Schutz gegen Infektion (rund 50% nach 6 Monaten). Eine dritte Impfdosis erhöht den Schutz gegen Infektion und Hospitalisiernug wieder auf mind. 95%. Weitere Darlegungen finden sich in dem Epi. Update vom 7.12.2021[^123].
...
Das relative Wachstum in der Schweiz scheint mit rund 0,17 (95% UI: 0,13-0,21) pro Tag etwas langsamer als in Südafrika und Grossbritannien zu sein, was möglicherweise auf eine vermehrte Verimpfung von Moderna und keinerlei Verimpfung von Oxford/AstraZeneca zurückzuführen ist.


##### Szenario zur epidemiologischen Ausbreitung in der Schweiz

Mit der für die Schweiz momentan geschätzten Wachstumsrate basierend auf sequenzierten Proben aus dem Zeitraum 24.11.2021-08.12.2021 kann ein Szenario für die zukünftige Entwicklung der Fallzahlen berechnet werden (Proben nach dem 8.12.2021 werden noch sequenziert und sind daher hier nicht eingeschlossen). Die Annahmen des Szenarios sind in der Legende von Abb. 1 beschrieben. Omikron wird in dem Szenario zwischen 24.12.2021 und 6.1.2022 mehr als 50% der Fälle ausmachen. In diesem Szenario werden vor Jahresende die Fallzahlen wieder anfangen zu steigen. Mit Reduzierung der Kontakte und dritten Impfungen kann die Dynamik verlangsamt werden und somit die Zunahme von Omikron verzögert werden. Das hier gezeigte Szenario sind Berechnungen unter der Annahme dass sich nichts aendert. Die Berechnungen erfolgen analog zu unseren Berechnungen für Alpha im Januar 2021 https://sciencetaskforce.ch/wissenschaftliches-update-26-januar-2021/. und sind im Detail in https://www.sciencedirect.com/science/article/pii/S1755436521000335?via%3Dihub beschrieben.

Abb. 1. Szenario zur Entwicklung der Fallzahlen. Wir nehmen an dass mit Start von KW 49 der R-Wert von Delta bei 0,9 lag und sich nicht weiter verändern wird. Die damit erwarteten Fallzahlen von Delta sind in Abb. 1 in blau dargelegt. Weiter nehmen wir an, dass die Häufigkeit von Omikron in den bestätigten Fällen zum Start von KW 49 bei 4% lag. Die logistische Wachstumsrate von Omikron im Vergleich zu Delta wird auf 0,17 (0,13-0,21) geschätzt. Die damit erwarteten Omikron Fallzahlen sind in orange dargestellt (durchgezogen mit Wachstum von 0,17; gestrichelte Linien mit 0,13 und 0,21). 
...
Gemäss dieser Studie ist die Hospitalisierungsrate nach Infektionen mit Omikron 29% niedriger als in der ersten Welle im Jahr 2020, bei Kindern aber 20% höher (bei vornehmlich milden Verläufen).

...
Ein Trend zu dieser Dynamik kann in allen Grossregionen der Schweiz beobachtet werden[^1].  <!--- CHECK 
...
in Kalenderwoche 6 des Jahres 2021 in der Schweiz identifiziert. B.1.1.7 ist in der Schweiz weit verbreitet (>80%). B.1.351 ist in KW 8 bei 3% mit steigendem Trend während P.1 nur vereinzelt auftritt. <!--- check ---->

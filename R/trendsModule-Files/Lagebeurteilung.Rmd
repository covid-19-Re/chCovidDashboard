...
r_cases_timeHosp <- r_cases_timeHosp[r_hosp2$date == max(r_hosp2$date),]
...
r_hosp_timeDeath <- r_hosp_timeDeath[r_deaths2$date == max(r_deaths2$date),]
r_cases_timeDeath <- r_cases_timeDeath[r_deaths2$date == max(r_deaths2$date),]
```

...
Im Vergleich zum Wildtyp ist die Übertragungsrate von B.1.1.7 höher [^13],[^18],[^16].
...
B.1.617.2 verdrängt B.1.1.7 in vielen britischen Städten und hat wahrscheinlich eine höhere Übertragungsrate, die sich aber noch nicht beziffern laesst[^31].
Einer neuen preprints von Public Health England[^30] zufolge ist der Schutz der Impfung gegen B.1.617.2 reduziert:

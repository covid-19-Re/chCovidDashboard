...
eine stabile und inzwischen möglicherweise leicht rückläufige Epidemie hin.

Eine genaue Quantifizierung ist momentan schwierig durch das veränderte Testverhalten und die fortschreitenden Impfungen. Daten aus der Abwasserüberwachung sind ein vom Testverhalten unabhängiger wichtiger Indikator. Abwasseranalysen aus Zürich[^26] und Lausanne[^27] bestätigen die basierend auf Fallzahlen beobachteten epidemiologischen Trends, d.h. einen stabilen Trend im April, nach einem Anstieg im Februar und März.
Abwasseranalysen von sechs Standorten bestätigen die basierend auf Fallzahlen beobachteten epidemiologischen Trends.


### Dynamik  
<!------ CHECK  -------->
Basierend auf den aktuellen Daten schätzen wir ein moderates Wachstum der SARS-CoV-2 Epidemie. Der 7-Tageschnitt der schweizweiten Reproduktionszahl ist bei
0.93 (0.81 - 1.06); dies reflektiert das Infektionsgeschehen vom 17.04.-23.04.2021[^1].
...
Eine Veränderung der Fallzahlen, Hospitalisierungen und Todesfällen stratifiziert nach Alter kann auf unserem Dashboard verfolgt werden[^17]. Der Effekt der Impfkampagne ist in der Altersgruppe über 75 Jahre sichtbar, wo wir einen Rückgang der Fallzahlen, Hospitalisierungen und Todesfälle beobachten. Während die Altersgruppe 75+ in der 2. Welle rund 50% der Hospitalisierungen ausgemacht hat, sind es inzwischen noch rund 20%. Dagegen sind die Hospitalisierungen bei den unter 65-jährigen von unter 30% in der 2. Welle auf nun über 60% gestiegen.

Momentan beobachten wir stabile Hospitalisierungszahlen. Bei genauerer Betrachtung fällt auf, dass die Hospitalisierungen in der Altersgruppe <55 zunehmen, während sie in der Altersgruppe >55 abnehmen. Generell bedeuten stabile Zahlen bei fortschreitender Durchimpfung dass die Krankheitslast in der noch nicht geimpften Bevölkerung zunimmt und in dem immer größeren Anteil der geimpften Bevölkerung abnimmt.

Durch fortschreitende Impfungen erwarten wir dass in den nächsten Wochen die Reproduktionszahl basierend auf Hospitalisierungen und Todesfällen die Transmissionsdynamik unterschätzt. Generell bedeuten stabile Zahlen bei fortschreitender Durchimpfung dass die Krankheitslast in der noch nicht geimpften Bevölkerung zunimmt und
in dem immer grösseren Anteil der geimpften Bevölkerung abnimmt.
<!--- CHECK ---->
...
in Kalenderwoche 6 des Jahres 2021 in der Schweiz identifiziert. B.1.1.7 ist inzwischen die dominante Virusvariante und die Epidemie in der Schweiz ist eine B.1.1.7 Epidemie[^15],[^16]. B.1.351 und P.1 treten momentan mit weniger als 1% auf[^28],[^29]. Die ursprünglich in Indien beschriebene B.1.617 Variante wurde erstmals in Kalenderwoche 16 des Jahres 2021 in der Schweiz identifiziert. <!--- check ---->
...
[^27]: https://sensors-eawag.ch/sarscov2/STEP_Vidy_ddPCR.html
[^28]: 'https://cov-spectrum.ethz.ch/explore/Switzerland/Surveillance/AllTimes/variants/json=%7B%22variant%22%3A%7B%22name%22%3A%22B.1.351%22%2C%22mutations%22%3A[]%7D%2C%22matchPercentage%22%3A1%7D'
[^29]: 'https://cov-spectrum.ethz.ch/explore/Switzerland/Surveillance/AllTimes/variants/json=%7B%22variant%22%3A%7B%22name%22%3A%22P.1%22%2C%22mutations%22%3A[]%7D%2C%22matchPercentage%22%3A1%7D'

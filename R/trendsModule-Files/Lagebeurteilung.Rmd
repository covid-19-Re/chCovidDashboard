...
Wir beobachten statistisch signifikant sinkende Fallzahlen in allen Altersgruppen.
Hospitalisierungszahlen sind in allen Altersgruppen im einstelligen Bereich, was die Schätzung eines zeitlichen trends erschwert. In den Gruppen der 45-54 Jährigen und 55-64 Jährigen ist die Abnahme der Hospitalisierungszahlen signifikant.
<!------ UPDATE -------->
<!------ TOO DETAILLED:
...
Seit März 2021 ist Alpha die dominante Virusvariante in der Schweiz[^15],[^16].
Im Vergleich zum Wildtyp ist die Übertragungsrate von Alpha etwa 50% höher [^13],[^18],[^16].
...
hatten über die letzten 14 Tage gemittelt eine Häufigkeit von respektive 0.5% und 1.6% [^29].
<!--- UPDATE cov-spectrum.ethz.ch-> see percentage of B.1.315 or P.1 on the left, which is the average over the past 14 days ---->

Die ursprünglich in Indien beschriebene Variante Delta (B.1.617.2), die Public Health England als "variant of concern (VOC)" klassifiziert hat, wurde bisher in 177 Fällen in der Schweiz nachgewiesen und hatte in der Kalenderwoche 22 eine Häufigkeit von 5,5% und in der Kalenderwoche 23 eine Häufigkeit von 20,4% unter den sequenzierten Fällen [^29].
...
Der Transmissionsvorteil von Delta gegenüber Alpha wurde im Rahmen einer Studie der University of Warwick zu 56% (95% Konfidenzintervall: 34%-81%) geschätzt, die in einem Preprint[^37] beschrieben ist.
In diesem Transmissionvorteil sind die Vorteile, die Delta hat, weil es der Immunantwort entkommt, noch nicht enthalten. 
Die Epidemie, die in Grossbritannien von Delta dominiert ist, steigt signifikant an (7-Tageschnitt der Reproduktionszahl ist 1,25 (1,14 - 1,35), gemessen vom 31. Mai - 6. Juni 2021[^1]).
...
nach der ersten Dosis BNT162b2 ist die Wirksamkeit gegen Delta nur 34% (statt 51% gegen Alpha),

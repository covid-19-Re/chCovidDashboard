...
<!------- UPDATE -------->
Seit Anfang September 2021 nahm die SARS-CoV-2-Epidemie ab (*R~e~*<1). Seit dieser Woche aber ist die Schätzung des R-Wertes wieder signifikant über 1.
...
und die Todesfälle fielen um `r valueUIchange(rankingCHEdeaths)`.
<!---- UPDATE ---->
...
Die Zahl der Fälle ist in allen Altersgruppen signifikant steigend, mit Ausnahme der Altersgruppen der 70-80 und der über 80-Jährigen.
...
Eine neue Studie aus Kalifornien[^54], schätzt die Wirksamkeit des Impfstoffs von Moderna gegen Infektionen mit Delta auf 87% (95% UI: 84-89%), gegen Infektion mit Alpha auf 98% (95% UI: 97-99%).
<!---
...
Ein neuer Preprint[^53] beschreibt eine Studie, die schätzt, dass das Übertragungsrisiko bei einer Durchbruchsinfektion mit der Delta-Variante nach zwei Injektionen des mRNA-Impfstoffs von Pfizer/BioNtech um etwa 2/3 geringer ist als bei Ungeimpften.

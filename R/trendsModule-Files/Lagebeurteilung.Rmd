...
Durch fortschreitende Impfungen der Risikogruppen erwarten wir dass in den nächsten Wochen die Reproduktionszahl basierend auf Hospitalisierungen und Todesfällen die Transmissionsdynamik nicht mehr zuverlaessig widergeben wird. Eine Veränderung dieser Zahlen stratifiziert nach Alter kann auf unserem neuen Dashboard verfolgt werden [^17]. Seit Wochen sehen wir eine verlangsamte Dynamik in der Altersgruppe über 80 bei den Fallzahlen und erkennen seit einigen Tagen auch einen  Trend bei den Hospitalisierungen. <!--- CHECK --->

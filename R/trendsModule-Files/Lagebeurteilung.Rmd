...
bestätigten Fälle, Hospitalisationen und Todesfälle über die letzten 14 Tage.[^2] Die bestätigten Falle änderten sich um -32.5% (UI: xxx-xx) pro Woche, die Hospitalisierungen um xxx (UI: xxx-xx) und die Todesfaelle um xxx (UI: xxx-xx).  <!---- TODO Dani - insert numbers automatically? --->
...
lag über die letzten 14 Tage
im Bereich von `r range(icu$count)[1]`-`r range(icu$count)[2]`[^3] Personen (die Aenderung war -10.7% (UI: xxx-xx) pro Woche). <!---- TODO Dani - insert numbers in this sentence automatically?  ---->

...
Aus diesem Anstieg der Häufigkeit von Delta kann man einen Transmissionsvorteil von 42-55% berechnen[^29].
...
Wir rechnen auch mit einem baldigem Anstieg von Hospitalisierungen, der wegen der geringeren Impfdeckung in der Schweiz verglichen mit Grossbritannien[^39] voraussichtlich einen grosseren Anteil der Infizierten betreffen wird.

...
Die zweite kritische Schwelle von 300 Intensivbettenbelegungen ist schon seit letzter Woche überschritten.
...
Von der Weltgesundheitsorganisation (WHO) wurde die neue Variante Omikron am 26.11.2021 als besorgniserregend deklariert. Auch in der Schweiz wurde diese Variante schon über 100-mal nachgewiesen.
...
Diese Woche ist der R-Wert nicht mehr über 1.
...
In der Schweiz wurde die Variante 135-mal nachgewiesen und hatte in der Kalenderwoche 49 einen Anteil von 8.6%[^25].
...
Zu ähnlichen Schätzungen kommt eine andere Studie des Imperial College[^318]: durch eine dritte Impfung wird der Schutz gegen symptomatische Infektion mit Omikron von 19% (95% UI: 13-24%) auf 77% (72-80%) erhöht.

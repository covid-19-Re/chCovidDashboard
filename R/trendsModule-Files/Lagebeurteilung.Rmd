...
Nachdem der Anstieg der Epidemie in der Schweiz diesen Herbst später begann als im Herbst 2020 und auch später als in anderen mitteleuropäischen Ländern, erwarten wir Ende November noch keine Überschreitung der Maximal-Last. Solch ein Szenario ist aber über den Winter nicht auszuschliessen.
Eine rasche Zunahme der Zahlen wäre für das immer noch stark belastete Gesundheitswesen sehr schwierig zu bewältigen.
<!------ UPDATE  -------->
...
<!------- UPDATE -------->
Seit Anfang September 2021 nahm die SARS-CoV-2-Epidemie ab (*R~e~*<1). Seit Ende Oktober 2021 aber ist die Schätzung des R-Wertes wieder signifikant über 1.
...
In den Altersgruppen der 0-9 und 10-19 Jährigen ist dieser Anstieg mit 65% und 43% pro Woche am höchsten, in den über 80 Jährigen mit 29% pro Woche am niedrigsten.
Hospitalisierungen stiegen oder fielen in keiner Altersgruppe über die letzten 14 erfassten Tage signifikant ausser in der Altersgruppe der über 80 Jährigen, in denen sie um 34% (95% UI: 1-78%) stiegen.
<!------ UPDATE -------->
...
Am 20. Oktober 2021 deklarierte Public Health England AY.4.2, eine Untervariante von Delta, zu einer "variant under investigation" (VUI-21OCT-01)[^56]. In England wurde der Wachstumstvorteil von AY.4.2 auf 17% gegenüber anderen Delta-Untervarianten geschätzt und hatte in der Kalenderwoche 40 eine Häufigkeit von 5.9%[^56]. Diese Variante wurde in der Schweiz in den letzten 2 Monaten rund 60 Mal gefunden und die Häufigkeit war in Kalenderwoche 43 0.6%[^25].
...
<!---
#### Schutz durch zwei Impfdosen vor Infektion
Der Schutz vor der symptomatischen Infektion ist anfänglich mit den in der Schweiz verwendeten mRNA Impfstoffen bei über 90%. Das gilt sowohl für die ursprüngliche Variante als auch für Delta.
Innerhalb weniger Monate nimmt der Schutz vor der Infektion aber über alle Altersklassen hinweg ab
(zum Beispiel für BioNTech[^101][^102] und für Moderna und BioNTech zusammen [^103][^104][^105])
Eine Übersicht in [^106].
Nach 6 Monaten ist der Schutz nur noch bei rund 50% gegenüber >90% direkt nach doppelter Impfung.

#### Schutz durch zwei Impfdosen vor Transmission
Innerhalb von 14 Wochen ist eine Abnahme des Schutzes als infizierter Geimpfter die Infektion
weiterzugeben von 50% auf 20% für Pfizer/BioNTech beobachtet worden 7 (im Vergleich zu infizierter
Ungeimpfter)
Schutz vor Hospitalisierung
○ Abnahme in älteren Personen nach 4-6 Monaten von >90% auf 80% für BioNTech 8 (auch in der
Schweiz im Oktober für über 80-Jährige beobachtet 9 ).
○ In breiter Bevölkerung ist Schutz bislang weiter sehr gut jedoch deuten Daten aus Israel ab 40-Jährigen
auf leichte Abnahme 10 .
---->

#### Schutz durch zwei Impfdosen vor Infektion (symptomatisch und asymptomatisch)
Die Wirksamkeit der Impfung auf Infektionen einschliesslich asymptomatischer ist schwierig abzuschätzen, weil gerade asymptomatische Infektionen schwer zu erfassen sind.
...
In den Zulassungsstudien für Pfizer/BioNtech wurde die die Wirksamkeit gegen die 2020 vorherrschenden Virusvarianten auf 95% (95% UI: 90-98%) geschätzt[^201] und für Moderna auf 94% (95% UI, 89-97%)[^202].
...
Studien aus Israel[^39] schätzen eine Wirksamkeit für BioNTec/Pfizer von nur 40% (95% UI: 9-61%) 6 Monate nach der zweiten Impfdosis.
Eine neue Studie aus Schweden[^58] schätzt für den Impfstoff von BioNTec/Pfizer einen Abfall des Schutzes
gegen symptomatische Infektion von 92% (95% UI: 92-93%) zwei bis vier Wochen nach der Impfung auf Null nach 210 Tagen.
...
Dies bedeutet dass junge doppelt geimpfte Menschen nach wie vor rund 20 Mal besser vor einer Hospitalisierung geschuetzt sind als nicht geimpfte Menschen (entspricht Schutz 95%). Bei aelteren doppelt geimpfte Menschen hat der Schutz abgenommen, sind noch rund 5 Mal besser geschützt (entspricht Schutz 80%).
...
Ein Preprint[^53] beschreibt eine Studie, in der geschätzt wurde, dass das Übertragungsrisiko bei einer Durchbruchsinfektion mit der Delta-Variante nach zwei Injektionen des mRNA-Impfstoffs von Pfizer/BioNtech um etwa 66% geringer ist als bei Ungeimpften (bedeutet ungeimpfte Infizierte übertragen 3x so viel im Vergleich zu geimpften Infizierten).
Die genauen Gründe für diesen Schutz sind nicht bekannt, obwohl er durch eine kürzere infektiöse Phase[^46] oder durch eine geringere Menge infektiöser Partikel des abgegebenen Virus bei geimpften Personen[^48] erklärt werden könnte.
...
Zwei Preprints[^111], [^112] beschreiben, dass eine dritte Impfdosis das Level neutralisierender Antikörper um das 10-fache erhöhen (verglichen mit dem Level unmittelbar vor der dritten Impfdosis).
Der Schutz vor der Infektion erhöht sich durch eine dritte Impfdosis von rund 50% auf mindestens 95% in allen Altersgruppen [^114] und auch in über 60-Jährigen [^113]. 
...
Insbesondere wird der Schutz in den über 80 Jährigen von 80% auf 95% erhöht[^113]. Für die Schweiz bedeutet dies dass eine dritte Impfdosis in dieser Alterskategorie ganz grob 10'000 Hospitalisierungen verhindern kann (Berechnungen der Task Force vom 21.9.2021: Anhang A in [^57]).

### Ziele einer Impfkampagne

In der Pandemie war das oberste Ziel durch Impfung einen raschen Schutz für die Menschen gegen schwere Verläufe zu erzielen. Daher wurden zwei Impfdosen mit sehr kurzem Abstand (meist 3-4 Wochen) verabreicht. Bei anderen nicht-replikationsfähigen Impfstoffen gilt die Grundimmunisierung erst mit einer zusätzlichen Dosis nach 6-12 Monaten als abgeschlossen (z.B. Hepatitis A und B, FSME, Haemophilus influenzae type B, Poliovirus, Diphterie, Tetanus oder Pertussis). Eine dritte Impfdosis ist deshalb nicht aussergewöhnlich und könnte zu einem dauerhafteren Schutz führen, sodass möglicherweise in der breiten Bevölkerung jährliche Auffrischungs-Impfungen nicht notwendig wären. Langfristig könnten, nach einem Impfschema mit drei Dosen, milde natürliche Infektionen möglicherweise einen breiten Schutz auch gegen neue Varianten erzeugen und den Übergang zur Endemizität von SARS-CoV-2 erleichtern.

...
<!--- RRR - THIS IS MISLEADING AS THE EARLIEST SAMPLE ON cov-spectrum.ethz.ch IS FROM WEEK 11: Die ursprünglich in Indien beschriebene B.1.617 Variante wurde erstmals in Kalenderwoche 16 des Jahres 2021 in der Schweiz identifiziert[^29]. ---->
Die ursprünglich in Indien beschriebene B.1.617 Variante ist seit der 16. Kalenderwoche des Jahres 2021 in der Schweiz in einer auf die 11. Kalenderwoche datierten Probe nachgewiesen[^29].

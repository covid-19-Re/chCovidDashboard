...
<!------- UPDATE -------->
Seit Anfang September 2021 nahm die SARS-CoV-2-Epidemie ab (*R~e~*<1). Seit letzter Woche aber ist die Schätzung des R-Wertes wieder signifikant über 1.
...
Die Zahl der Fälle ist in allen Altersgruppen signifikant steigend, mit Ausnahme der Altersgruppen der 20-29 und 60-69-Jährigen.
...
Seit Kalenderwoche 26 ist Delta (B.1.617) die dominante Variante in der Schweiz.
...
Für Oktober sehen wir in der Schweiz nun jedoch eine Abnahme der Wirksamkeit in den über 80-Jährigen von 89-94% im September auf 73-87% im Oktober[^57]. Diese Abnahme ist konsistent mit Daten aus anderen Ländern. 

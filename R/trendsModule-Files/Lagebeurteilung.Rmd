...
Seit letzter Woche steigen die Fallzahlen wieder.
Dieser Trend wird auch in Abwasserproben beobachtet [^23],[^62].
Der R-Wert basierend auf Fallzahlen war von 23. Januar bis 15. Februar 2022 signifikant unter 1.
Seit dieser Woche ist die aktuellste Schätzung des R-Wertes signifikant über 1.

Der Anstieg der Fallzahlen betrifft auch die über 60-Jährigen, was zu einer baldigen Belastung der Spitäler führen könnte.
Im Gegensatz zu letzter Woche nehmen die IPS-Belegung und die Spitaleintritte nicht mehr statistisch signifikant ab.

In der Schweiz ist seit Kalenderwoche 51 2021 die Omikron Variante dominant. Seit Kalenderwoche 3 2022 hat diese Variante eine Häufigkeit von über 95% aller Infektionen in der Schweiz. Es zirkulieren die Omikron Varianten BA.1 und BA.2. BA.1 hatte in Kalenderwoche 3 eine Häufigkeit von über 95%. Seitdem geht die Häufigkeit von BA.1 zurück und war in Kalenderwoche 8 2022 bei 57%. Die Omikron-Untervariante BA.2 hat die letzten Wochen zugenommen und machte in Kalenderwoche 8 2022 42% der sequenzierten Proben aus.
...
war von 23. Januar bis 15. Februar 2022 signifikant unter 1.
...
Die Zahl der Fälle stieg in allen Altersgruppen über die letzten 14 Tage signifikant ausser bei den 0-9 und 10-19 Jährigen.  
...
Seit Kalenderwoche 51 2021 ist der Omikron-Subtyp BA.1 in der Schweiz dominant und wurde über 20'000-mal nachgewiesen. Nachdem BA.1 in KW 3 2022 eine Häufigkeit von über 95% hatte ist die Häufigkeit dann gesunken auf 57% in Kalenderwoche 8 2022[^25]. Der Omikron-Subtyp BA.2 wurde erstmals in KW 52 2021 in der Schweiz nachgewiesen. Seitdem wurde dieser Subtyp fast 2000-mal nachgewiesen und hatte in Kalenderwoche 8 2022 einen Anteil von 42% unter allen sequenzierten Proben[^25]. 
<!--- UPDATE ---->
...
<!--- The secondary attack rate (SAR) was estimated as 29% and 39% in17
...
Gemäss der UK Health Security Agency (UKHSA) ist der Schutz der Impfung vor symptomatischer Infektion mit BA.2 gleich wie für BA.1[^354].
...
Hingegen ist bei BA.2 die Aktivität des monoklonalen Antikörpers Sotrovimab, der in der Schweiz therapeutisch eingesetzt wird, deutlich vermindert[^348],[^349].
Obwohl BA.2 in Hamstern schwerere Verläufe zeigt als BA.1[^352], gibt in epidemiologischen Daten aus Südafrika[^353], Grossbritannien und Dänemark keine Anzeichen für einen Unterschied in der Schwere[^351].
...
Momentan wird eine Trendwende in den Fallzahlen beobachtet. Dies kann durch den Übertragungsvorteil von BA.2 sowie durch Auswirkungen der Oeffnungsschritte aus Kalenderwoche 7 erklärt werden. Einem Bericht einer Forschungsgruppe der TU Berlin zufolge[^350] wird, selbst bei optimistischen Szenarien mit hoher Kreuzimmunität, auch ein erneuter Anstieg der Fallzahlen in Deutschland erwartet.
<!--- UPDATE ---->

...
Dennoch stiegen Hospitalisierungen in den Altergruppen der 35 bis 44-Jährigen und 55 bis 64-Jährigen von 23. Juli bis 5. August 2021 signifikant an.
<!------ UPDATE -------->
...
Studien welche die Wirksamkeit von mRNA Impfstoffen gegen eine Infektion (einschliesslich asymptopmatischer) quantifizieren sind am Laufen.
...
Gemäss eines Berichtes von Public Health England[^41] ist die Wirksamkeit von 89% [87-90%] gegen Alpha auf 79% [78-80%] gegen Delta gesunken (siehe auch [^42], [^36]; Pfizer/BioNtech).

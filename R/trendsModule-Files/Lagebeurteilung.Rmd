...
Die ursprünglich in Indien beschriebene Variante Delta (B.1.617.2), die Public Health England als "variant of concern (VOC)" klassifiziert hat, wurde bisher in 132 Fällen in der Schweiz nachgewiesen und hatte in der Kalenderwoche 22 eine Häufigkeit von 4,5% und in der Kalenderwoche 23 eine Häufigkeit von 16,5% unter den sequenzierten Fällen [^29]. Wegen Verzögerungen, mit denen die Sequenzen erfasst werden, können sich diese Häufigkeit, vor allem in Kalenderwoche 23, noch ändern.

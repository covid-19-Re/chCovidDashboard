...
Seit vorletzter Woche steigt auch die Belegung der Intensivstationen mit COVID-19 Patienten signifikant an, mittlerweile mit einer Rate von 22% (95% UI: 5-29%) pro Woche.
In der vorletzten Woche wurde auch schon die erste kritische Schwelle von 200 Intensivbettenbelegungen überschritten,
...
Seit letzter Woche steigen auch die Todesfälle signifikant an, mit einer momentanen Rate von 42% pro Woche (95% UI: 12-82%). 
<!------ UPDATE  -------->
...
Die Zahl der Fälle ist in allen Altersgruppen signifikant steigend ausser in den 60-69 Jährigen, 70-79 Jährigen und über 80 Jährigen.
In der Altersgruppe der 0-9 Jährigen ist dieser Anstieg mit 22% (95% UI: 11-34%) pro Woche am höchsten,
Im Gegensatz zu vorletzter Woche, stiegen
Die Hospitalisierungen stiegen nur in der Altersgruppe der 50-59 Jährigen signifikant an mit einer Rate von 37% (95% UI: 3-83%) pro Woche über die letzten 14 erfassten Tage.
<!------ UPDATE -------->
...
Die Zahl der täglich neu hospitalisierten Menschen ist im 7-Tage Mittel bei rund 80.
<!--- UPDATE ---->
...
In der Schweiz wurde die Variante mehrmals nachgewiesen[^303] (in Basel, Zurich und Bern).

...
### Dynamik  
<!--- CHECK  ---->
Basierend auf den aktuellen Daten schätzen wir ein exponentielles Wachstum der SARS-CoV-2 Epidemie. Der 7-Tageschnitt der schweizweiten Reproduktionszahl ist bei 1.12 (0.99 - 1.25); dies reflektiert das Infektionsgeschen vom 27.02.-05.03.2021.
Diese Dynamik kann in 5/7 Grossregionen der Schweiz beobachtet werden. Lediglich die Genferseeregion un das Mittelland rapportieren nach wie vor stabile Fallzahlen[^1].  <!--- CHECK 
...
Durch fortschreitende Impfungen der Risikogruppen erwarten wir dass in den nächsten Wochen die Reproduktionszahl basierend auf Hospitalisierungen und Todesfällen die Transmissionsdynamik nicht mehr zuverlässig wiedergegeben wird. Eine Veränderung dieser Zahlen stratifiziert nach Alter kann auf unserem neuen Dashboard verfolgt werden [^17]. Seit Wochen sehen wir eine verlangsamte Dynamik in der Altersgruppe über 80 bei den Fallzahlen und erkennen seit einigen Tagen auch eine verlangsamte Dynamik in dieser Altersgruppe bei den Hospitalisierungen im Vergleich zu den jüngeren Altersgruppen. Die Veränderung der absoluten Zahlen kann auf[^17] abgerufen werden.
 <!--- CHECK --->
...
<!---- schieben wir hier 1 Tag zu viel? fuer heute 8.3. haette ich positivitaet fuer 5.3 erwartet. aber es wird 4.3. rapprotiert. TODO dani?---->

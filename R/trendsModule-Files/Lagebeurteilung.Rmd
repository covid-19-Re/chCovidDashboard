...
Im März 2021 war Alpha (B.1.1.7) die dominante Virusvariante in der Schweiz geworden[^15],[^16], deren Übertragungsrate um etwa 50% höher als die des Wildtyps ist [^13],[^18],[^16]. Die Häufigkeit dieser Variante beträgt derzeit weniger als 2%.
...
Neuere Daten deuten darauf hin, dass die Hospitalisierungsrate nach einer Infektion mit der Delta-Variante im Vergleich zur Alpha-Variante um 74% bis 85% erhöht ist[^36],[^37].
Andererseits ist der Schutz durch die Impfung gegen Delta leicht reduziert [^26]: Nach der ersten Dosis von BNT162b2 (dem Impfstoff von BioNTech/Pfizer) beträgt die Wirksamkeit gegen Delta nur 34 % (statt 51 % gegen Alpha), nach der zweiten Dosis 88 % (statt 93 % gegen Alpha).
...
Wir rechnen auch mit einem weiteren Anstieg von Hospitalisierungen, der wegen der geringeren Impfdeckung in der Schweiz verglichen mit Grossbritannien[^34] voraussichtlich einen grösseren Anteil der Infizierten betreffen wird.
...
[^34]: https://sciencetaskforce.ch/en/scientific-update-of-6-july-2021/

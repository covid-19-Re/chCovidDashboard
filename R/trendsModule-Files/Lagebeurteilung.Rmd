...
Nachdem der Anstieg der Epidemie im Herbst 2021 später begann als im Herbst 2020, erwarten wir Ende November noch keine Überschreitung der Maximal-Last. Solch ein Szenario ist aber über den Winter nicht auszuschliessen.
...
Die Todesfälle gingen um `r valueUIchange(rankingCHEdeaths)` zurück.
<!---- UPDATE ---->
...
In den Altersgruppen der 0-9 und 10-19 Jährigen ist dieser Anstieg mit 78% und 61% pro Woche am höchsten. 
Hospitalisierungen stiegen oder fielen in keiner Altersgruppe über die letzten 14 erfassten Tage signifikant.
<!------ UPDATE -------->

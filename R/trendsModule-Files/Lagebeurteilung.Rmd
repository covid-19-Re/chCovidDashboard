...
Basierend auf den aktuellen Daten schätzen wir, dass die Abnahme der SARS-CoV-2 Epidemie der letzten zwei Wochen sich verlangsamt. Der 7-Tageschnitt der schweizweiten Reproduktionszahl ist bei `r valueUIr(r_mean7d, uiText = "")`; dies reflektiert das Infektionsgeschehen vom `r r_mean7d_dateRange_str`[^1].
...
Für die Gruppe der 65 bis 74-Jährigen ist diese Reduktion statistisch signifikant.
<!------ UPDATE -------->
<!------ TOO DETAILLED:
...
In den schweizer Daten sehen wir eine erhöhte Wahrscheinlichkeiten einer Hospitalisierung in manchen Altersgruppen. 
Eine 50-59 jährige positiv getestete Person hat beispielsweise ein Risiko von 4.5% eines Spitaleintritts in 2021, wenn sie mit der Variante B.1.1.7 infiziert ist. Für eine Person, die mit einer anderen Variante infiziert ist, liegt dieses Risiko fast dreimal niedriger bei 1.6%[^29].
...
Die ursprünglich in Indien beschriebene B.1.617 Variante wurde bisher in 52 Fällen in der Schweiz nachgewiesen.

...
Wir beobachten einen statistisch signifikanten, relativ gleichmässigen Anstieg der Zahl der Fälle in allen Altersgruppen.
...
Dennoch stiegen Hospitalisierungen in den Altersgruppen der unter 8-Jährigen, der 25 bis 34-Jährigen und der 45 bis 54-Jährigen von 29. Juli bis 11. August 2021 signifikant an.
<!------ UPDATE -------->
...
in der Kalenderwoche 31 eine Häufigkeit von 91%
unter den sequenzierten Fällen[^25].
Wegen Verzögerungen, mit denen die Sequenzen erfasst werden, können sich diese Häufigkeit, vor allem in Kalenderwoche 31, noch ändern.
Aus diesem Anstieg der Häufigkeit von Delta kann man einen Transmissionsvorteil gegenüber Alpha von 72-80% berechnen[^25].
<!--- UPDATE cov-spectrum.ethz.ch-> click on B.1.617.2 and look at the number/percentage by calendar week on the right graph  ---->

Die früher in der Schweiz beobachteten SARS-CoV-2-Varianten, darunter die von März bis Juni 2021 dominierende Alpha-Variante, aber auch die Beta- und Gamma-Varianten, die immer selten waren, haben jeweils eine Häufigkeit von <1% in den letzten Wochen[25].
...
Studien welche die Wirksamkeit von mRNA Impfstoffen gegen eine Infektion (einschliesslich asymptomatischer) quantifizieren sind am Laufen.
...
Der Impfschutz gegen schwere Erkrankung ist nach wie vor hoch. Die Wirksamkeit liegt bei ungefähr 96% [91-98%] basierend auf Daten aus Grossbritannien[^47],[^44] und 88% (78,9-93,2%) basierend auf Daten aus Israel [^39]. Das bedeutet, dass mindestens 9 von 10 Hospitalisationen durch eine vollständige Impfung verhindert werden können.

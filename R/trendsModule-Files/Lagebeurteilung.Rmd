...
Die Zahl der bestätigten Fälle steigt seit dem kontinuierlich an, obwohl dieser Antieg während der letzten 14 Tage nicht mehr signifikant war.
Der R-Wert war in der ersten Woche des Jahres 2022 kurzzeitig nicht mehr über 1,
ist aber seit der zweiten Kalenderwoche signifikant über 1.
Diese Bewegung des R-Wertes könnte auf Anstieg der Test-Intesität von der ersten zur zweiten Jahreswoche hindeuten.
Diese Interpretation wird unterstützt durch Messungen von SARS-CoV-2 im Abwasser[^23]: im Gegensatz zu den gemeldeten Fällen steigt die SARS-CoV-2 Konzentration in keinem der sechs beobachteten Kläranlagen an.
Es ist deshalb, trotz der noch steigenden Fallmeldungen möglich, dass der Peak der Omikronwelle schon überschritten ist.


### Dynamik

<!------- UPDATE -------->
Am Anfang des Jahres 2022 war der R-Wert kurzzeitig unter 1.
Seit Kalenderwoche 2 2022 ist er signifikant über 1.
...
Insbesondere waren Spitalmeldungen in den letzten Wochen unvollständig.
...
wobei diese Zahl wegen den oben erwähnten Meldeverzögerungen noch verfälscht sein könnte.
Die Todesfälle fielen mit einer Rate von `r valueUIchange(rankingCHEdeaths)` pro Woche.
<!---- UPDATE ---->
...
Die Zahl der Fälle nahm in keiner Altersgruppe signifikant zu.
...
Seit Kalenderwoche 51 2021 ist die Omikron Variante In der Schweiz dominant
und wurde etwa 9000-mal nachgewiesen und hatte in der Kalenderwoche 3 2022 einen Anteil von 98% unter allen sequenzierten Proben[^25].
<!--- UPDATE ---->

Die bisherigen Studien zur epidemiologischen Ausbreitung von Omikron, den Impfschutz gegen diese Variante und der Schwere von Omikron-Infektionen sind im epidemiologischen Bericht vom 3. Januar 2022[^344] zusammengefasst.

...
Die zweite kritische Schwelle von 300 Intensivbettenbelegungen ist schon fast erreicht.
...
Die beobachtete rasche Zunahme der Fälle in den letzten Wochen, und damit der momentane Anstieg in Intensivbettenbelegungen, wird für das immer noch stark belastete Gesundheitswesen sehr schwierig zu bewältigen sein. 
<!------ UPDATE  -------->
...
Wir rechnen damit, dass diese Variante in den nächsten Wochen dominant wird und Anfang 2022 das Infektionsgeschehen dominiert.
...
In den 70-79 Jährigen und über 80 Jährigen sinkt sie signifikant.
...
In der Schweiz wurde die Variante 37-mal nachgewiesen[^303].
...
Forschungsergebnisse der letzten Woche[^307],[^308],[^309],[^310],[^315] zeigen eine starke Verringerung der Neutralisation von Omikron mit Seren von Geimpften und Genesenen.
...
Ein Preprint[^311] hat auf Grund epidemiologischer Daten die Wirksamkeit der Impfstoffe von Oxford/AstraSeneca und BioNTech/Pfizer gegen die symptomatische Infektion mit Omikron geschätzt:
...
Dies entspricht in etwa dem Schutz von doppelt Geimfpten bei Delta. Die langfristige Wirkung kann noch nicht beurteilt werden.
<!--- UPDATE ---->
...
Zur Schutzwirkung der Impfung gegen schwere Verläufe bei Infektion mit Omikron liegen noch keine Daten vor.
Diese werden in den nächsten Wochen erwartet. 

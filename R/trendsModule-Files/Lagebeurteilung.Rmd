...
und Delta (B.1.617.2) hatten über die letzten 14 Tage gemittelt eine Häufigkeit von respektive 0.5% und 1.6% [^29].
<!--- UPDATE cov-spectrum.ethz.ch-> see percentage of B.1.315 or P.1 on the left, which is the average over the past 14 days ---->

Die ursprünglich in Indien beschriebene Variante Delta (B.1.617.2), die Public Health England als "variant of concern (VOC)" klassifiziert hat, wurde bisher in 177 Fällen in der Schweiz nachgewiesen und hatte in der Kalenderwoche 22 eine Häufigkeit von 5,5% und in der Kalenderwoche 23 eine Häufigkeit von 20,4% [^29].

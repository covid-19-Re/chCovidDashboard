...
Die SARS-CoV-2-Epidemie wird zurzeit fast ausschliesslich durch die Delta-Variante (B.1.617.2) verursacht, die im Sommer die zuvor zirkulierenden Varianten abgelöst hat. Die Zahl der Fälle und Krankenhausaufenthalte stieg zwischen Ende Juni und Mitte August 2021 an, stabilisierte sich dann einen Monat lang auf hohem Niveau, und geht seit Anfang September 2021 wieder zurück. Es wird erwartet, dass die Zirkulation saisonal bedingt wieder zunehmen wird was zu einem R-Wert von über 1 führen könnte. Eine rasche Zunahme der Zahlen wäre für das immer noch stark belastete Gesundheitswesen sehr schwierig.
<!------ UPDATE  -------->
...
<!------- UPDATE -------->
Seit Anfang September 2021 nimmt die SARS-CoV-2-Epidemie ab. Der 7-Tageschnitt der schweizweiten Reproduktionszahl ist bei `r valueUIr(r_mean7d, uiText = "95% Unsicherheitsintervall, UI")`; dies reflektiert das Infektionsgeschehen vom `r r_mean7d_dateRange_str`[^1].
...
Die Zahl der Fälle ist in allen Altersgruppen signifikant rückläufig, mit Ausnahme der Altersgruppen der 20-30, 70-80 und über 80-Jährigen.
Hospitalisierungen fielen über die letzten 14 erfassten Tage signifikant. Bei getrennter Betrachtung der Altersgruppen ist dieser Trend aber für keine der Altersgruppen signifikant.
<!------ UPDATE -------->
...
in der Kalenderwoche 38 eine Häufigkeit von 99.9%

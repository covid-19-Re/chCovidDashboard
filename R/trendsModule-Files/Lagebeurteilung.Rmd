...
Dennoch stiegen Hospitalisierungen in den Altersgruppen der 35 bis 44-Jährigen und 55 bis 64-Jährigen von 23. Juli bis 5. August 2021 signifikant an.
<!------ UPDATE -------->
...
Die früher in der Schweiz beobachteten SARS-CoV-2-Varianten, darunter die von März bis Juni 2021 dominierende Alpha-Variante, aber auch die Beta- und Gamma-Varianten, die immer selten waren, haben eine Gesamthäufigkeit von <2% in den letzten Wochen[25].
...
Gemäss einem Bericht von Public Health England[^41] ist die Wirksamkeit von 89% (87-90%) gegen Alpha auf 79% (78-80%) gegen Delta gesunken (siehe auch [^42], [^36]; Pfizer/BioNtech).

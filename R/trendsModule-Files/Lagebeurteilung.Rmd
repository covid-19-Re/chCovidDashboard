...
Die Hospitalisierungen stiegen nur in der Altersgruppe der 40-49 Jährigen signifikant an.
Aber die Anzahl der Hospitalisierungen könnte, wie auch letzte Woche, unterschätzt sein.
<!------ UPDATE -------->
...
Daten aus Südafrika erlauben eine vorläufige Schätzung des Transmissionsvorteils von Omikron gegenüber Delta von 0.32 (95% UI: 0.09-0.55) pro Tag[^314].
...
Ein Preprint[^311] hat auf Grund epidemiologischer Daten die Wirksamkeit der Impfstoffe von Oxford/AstraSeneca und BioNtec/Pfizer gegen die symptomatische Infektion mit Omikron geschätzt: der Schutz von Pfizer/BioNtec fiel von 88% 2-9 Woche nach der zweiten Impfung auf rund 35% nach 15 Wochen.

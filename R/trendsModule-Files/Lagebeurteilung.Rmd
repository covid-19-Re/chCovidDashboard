...
### Dynamik  
<!---- CHECK  ------>
Basierend auf den aktuellen Daten schätzen wir ein exponentielles Wachstum der SARS-CoV-2 Epidemie. Der 7-Tageschnitt der schweizweiten Reproduktionszahl ist bei 1.18 (1.04 - 1.33); dies reflektiert das Infektionsgeschen vom 13.03.-19.03.2021.
...
in Kalenderwoche 6 des Jahres 2021 in der Schweiz identifiziert. B.1.1.7 ist inzwischen die dominante Virusvariante und die Epidemie in der Schweiz ist eine B.1.1.7 Epidemie[^15],[^16]. B.1.351 tritt im niederen einstelligen Prozentbereich auf während P.1 nur vereinzelt auftritt. <!--- check ---->
